...
export function isAgentInboxInterruptSchema(
  ...
  return (
    ...
    "allow_respond" in (valueAsObject as any).config &&
    "allow_accept" in (valueAsObject as any).config &&
    "allow_edit" in (valueAsObject as any).config &&
    "allow_ignore" in (valueAsObject as any).config
  );
}
